      ...
      <section key={index} onClick={() => setSelected(index)}>
        <article className="rounded p-2 pb-2 ">
          <div className="relative h-[45px] cursor-pointer" >
            {selected === index && <Image src={AppImage.bg} alt="background-image" layout="fill" objectFit='cover' />}
            <div className="container mx-auto lg:max-w-6xl px-5 h-[48px] flex justify-between items-center relative">
          ...
          {selected === index && <p className="container mx-auto lg:max-w-6xl px-5  leading-7 mt-5 text-[#a1a1a1]">
